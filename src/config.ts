...
interface LoadedConfig {
  servers: GatewayConfig;
  codegraph: CodeGraphConfig;
}

export class Config {
  private servers: GatewayConfig;
  private codegraph: CodeGraphConfig;
   ...
   */
  private load(): LoadedConfig | null {
    ...
    const servers: GatewayConfig = {};
    for (const [key, value] of Object.entries(parsed)) {
      if (key.startsWith("_")) continue; // metadata (e.g. "_note"), not a server
